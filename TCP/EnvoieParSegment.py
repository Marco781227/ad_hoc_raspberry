...
def envoie():
    ...
    client.settimeout(30) # Si jamais on reste +30s sur recv sans message , on termine sans erreur
    ...
    while i < len(segments) : # On envoie tout les segments
        ...
        try : 
            ...
            if ack.decode() == str(i): 
                ...
                i = i + 1 
                save_index(i)
            elif ack : # Si on reçois un ack mais que c'est pas le bon = On est pas synchro donc on reset l'envoie 
