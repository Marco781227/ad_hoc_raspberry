...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as serversocket:
    ...
    client_socket.settimeout(
        30
    )  # On attend 30s avant de fermer la connexion avec timeout
        ...
        while True:
            try:
                ...
                if data.decode() == "finish":
                    ...
                    data.decode() == "reset"
                ):  # On reset, met a jours l'index et le fichier
                    ...
                    data
                ):  # On ecrit et envoie le ack de bien reçus puis on incremente l'index
                    f.write(data)
